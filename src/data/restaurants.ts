...
const fixtures: Array<Omit<Restaurant, 'profile' | 'inspections'> & { inspections: Inspection[] }> = [
  {
    id: '1', facilityId: 'AUS-1001', name: 'Juniper Table', address: '2400 E Cesar Chavez St, Austin, TX', latitude: 30.2547, longitude: -97.7167,
  ...
  {
    id: '2', facilityId: 'AUS-1002', name: 'Barton Bakehouse', address: '1700 S Lamar Blvd, Austin, TX', latitude: 30.2522, longitude: -97.7661,
  ...
  {
    id: '3', facilityId: 'AUS-1003', name: 'North Loop Noodles', address: '5301 Airport Blvd, Austin, TX', latitude: 30.3208, longitude: -97.7150,
  ...
  {
    id: '4', facilityId: 'AUS-1004', name: 'Violet Crown Tacos', address: '1111 E 6th St, Austin, TX', latitude: 30.2639, longitude: -97.7295,
  ...
  {
    id: '5', facilityId: 'AUS-1005', name: 'South Congress Kitchen', address: '2100 S Congress Ave, Austin, TX', latitude: 30.2429, longitude: -97.7522,
    inspections: [
